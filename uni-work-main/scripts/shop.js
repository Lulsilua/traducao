const allProducts = [
    { name: 'Mouse Gamer', price: 50, brand: 'Brand A', image: 'https://via.placeholder.com/150?text=Gaming+Mouse' },
    { name: 'Teclado Mecânico', price: 120, brand: 'Brand B', image: 'https://via.placeholder.com/150?text=Mechanical+Keyboard' },
    ...
    { name: 'Monitor Gamer', price: 299, brand: 'Brand A', image: 'https://via.placeholder.com/150?text=Gaming+Monitor' },
...
function displayFilteredProducts(products) {
    ...
    productList.innerHTML = products.map(product =>
        `<div class="product-card">
            ...
            <button onclick="addToCart(event, '${product.name}', ${product.price})">Adicionar ao carrinho</button>
        </div>`
    ).join('');
}
...
function checkout() {
    if (cart.length === 0) {
        alert("Seu carrinho esta vazio, coloque algum produto para proceder.");
    } else {
